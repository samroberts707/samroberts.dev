      ...
      <div class="illustration">
        ...
        <g id="Person">
          <g id="Head" ref="head">
            ...
            <path class="st5" d="M525.9,336.6c-1.5,0.7-3,1.2-4.5,1.7c-10.8,3.7-21.6,7.5-33,8.8c-11.3,1.4-23.3,0.2-33.2-5.5
            ...
            <path class="st6" d="M473.2,200c-2.9,0.8-6,0.1-8.3-1.8l2.1,2.9c-2.5,0.3-5-0.5-6.8-2.2c-0.2,2.6-0.1,5.2,0.3,7.8
              ...
              <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="597.79" y1="550.4099" x2="597.79" y2="173.0758" gradientTransform="matrix(1 0 0 1 -79.34 11.09)">
          ...
          <g id="Headphones" v-on:click="playMusic()" ref="headphones">
            ...
            <path class="st23" d="M544.3,262.9L544.3,262.9c2.2,0,4.1,1.8,4.1,4.1v32.5c0,2.2-1.8,4.1-4.1,4.1l0,0c-2.2,0-4.1-1.8-4.1-4.1V267
            ...
            <path class="st23" d="M432.8,304L432.8,304c-2.2,0-4.1-1.8-4.1-4.1v-32.5c0-2.2,1.8-4.1,4.1-4.1l0,0c2.2,0,4.1,1.8,4.1,4.1v32.5
              C436.8,302.2,435,304,432.8,304z"/>
            <path class="st24" d="M550.1,213.9c-7.1-14.7-22.4-32.4-55.6-33.9l0,0h-0.4l0,0l-11.7,0.6v0.1c-32.9,1.5-48.2,19.2-55.3,33.8
        ...
        <g id="Music_1_">
          <path id="Note4" ref="note4" class="st2" d="M571.2,173.2v26.6c-0.9-0.3-1.8-0.4-2.7-0.4c-4,0-7.2,2.8-7.2,6.8c0,4,3.2,6.7,7.2,6.7
          ...
          <path id="Note3" ref="note3" class="st2" d="M550.1,170.2v17.9c-3.2-1.9-7.4-0.8-9.2,2.5c-1.9,3.2-0.8,7.4,2.5,9.2s7.4,0.8,9.2-2.5
            c0.6-1,0.9-2.2,0.9-3.4V177h6.8v-6.8H550.1z"/>
          <path id="Note2" ref="note2" class="st2" d="M430.6,143.4V170c-0.9-0.3-1.8-0.4-2.7-0.4c-4,0-7.2,2.8-7.2,6.8c0,4,3.2,6.7,7.2,6.7
          ...
          <path id="Note1" ref="note1" class="st2" d="M409.5,140.5v17.9c-3.2-1.9-7.4-0.8-9.2,2.5c-1.9,3.2-0.8,7.4,2.5,9.2c3.2,1.9,7.4,0.8,9.2-2.5
...
export default {
  ...
  mounted () {
    ...
    const headphones = this.$refs.headphones
    const note1 = this.$refs.note1
    const note2 = this.$refs.note2
    const note3 = this.$refs.note3
    const note4 = this.$refs.note4

    var min = 200
    var max = 600

    // Leaf Wobble Animation
    this.$anime.timeline({ easing: 'linear', loop: true, targets: [leaf, leafVeins] }).add({ rotate: 3 }).add({ rotate: -3 }).add({ rotate: 0 })
    // Triple Spinner Animation
    this.$anime.timeline({ easing: 'linear', loop: true, duration: 2000, targets: spinner1 }).add({ rotate: 130 }).add({ rotate: -90 }).add({ rotate: 0 })
    this.$anime.timeline({ easing: 'linear', loop: true, duration: 3000, targets: spinner2 }).add({ rotate: 360 })
    this.$anime.timeline({ easing: 'linear', loop: true, duration: 1500, targets: spinner3 }).add({ rotate: -360 })
    // Head bobbing animation
    this.$anime.timeline({ easing: 'linear', loop: true, targets: [head, headphones] }).add({ translateY: 5, rotateX: 10 }).add({ translateY: 0, rotateX: 0 })
    // Note 1 Animation
    this.$anime.timeline({ easing: 'linear', loop: true, targets: note1, duration: 750 }).add({ translateY: -25, opacity: 1 }, Math.random() * (+max - +min) + +min).add({ translateY: -50, opacity: 0 })
    // Note 2 Animation
    this.$anime.timeline({ easing: 'linear', loop: true, targets: note2, duration: 750 }).add({ translateY: -25, opacity: 1 }, Math.random() * (+max - +min) + +min).add({ translateY: -50, opacity: 0 })
    // Note 3 Animation
    this.$anime.timeline({ easing: 'linear', loop: true, targets: note3, duration: 750 }).add({ translateY: -25, opacity: 1 }, Math.random() * (+max - +min) + +min).add({ translateY: -50, opacity: 0 })
    // Note 4 Animation
    this.$anime.timeline({ easing: 'linear', loop: true, targets: note4, duration: 750 }).add({ translateY: -25, opacity: 1 }, Math.random() * (+max - +min) + +min).add({ translateY: -50, opacity: 0 })
  }
}
</script>
