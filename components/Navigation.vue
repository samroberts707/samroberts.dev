<template>
  <nav>
    <div class="navbar">
      <div class="hamburger" :class="{ active: isOpen }" @click="toggleNav">
        <span />
        <span />
        <span />
      </div>
    ...
    <div class="nav-menu" :class="{ active: isOpen }">
      ...
      <div class="quick-contact">
        ...
        <div class="socials">
          ...
          <a href="https://github.com/samroberts707" target="_blank"><img class="social github" src="~/assets/icons/github_icon.png" alt="Twitter" /></a>
        </div>
      </div>
    </div>
  </nav>
  ...
  nav {
    ...
    div.nav-menu {
      ...
      div.content {
        ...
        padding: 0px 150px;
        opacity: 0;
        transition: opacity .9s ease-in-out, padding .9s ease-in-out;
        span {
          display: block;
          position: relative;
          font-size: 16px;
